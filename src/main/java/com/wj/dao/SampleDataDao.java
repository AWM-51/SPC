...
public class SampleDataDao {
    ...
    private static String INSERT_SAMPLE_DATA_SQL=" INSERT INTO sample_Data(g_id,value,s_status) VALUE(?,?,?) ";
    ...
    public void insertSampleData(SampleData sampleData){
        Object[] arg={sampleData.getG_id(),sampleData.getValue(),sampleData.getS_status()};
